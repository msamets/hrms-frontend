...
export default function JobSeekerTableForSystemEmployee() {
    return (
        <div className="jobSeekerTableForSystemEmployee">
            ...
            <div className="jobSeekerTableForSystemEmployee--Pagination">
            <Pagination
                    boundaryRange={0}
                    defaultActivePage={1}
                    ellipsisItem={null}
